...
function GoBack({ classses }) {
    const navigate = useNavigate()
    const goBack = () => navigate(-1)

    return (
        <div className={cn(styles.container, classses)} onClick={goBack}>
            <svg className={styles.arrow} viewBox="0 0 512 512">
            ...
            <h2 className={styles.text}>Go Back</h2>
        </div>
    )
}
