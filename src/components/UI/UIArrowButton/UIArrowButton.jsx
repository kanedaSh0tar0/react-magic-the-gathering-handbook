...
import styles from './UIArrowButton.module.css'

function UIArrowButton({ onClick, direction, disable }) {
    return (
        <button className={styles.button} disabled={disable}>
            <svg className={cn(styles.arrow, direction && styles.arrowLeft)} onClick={onClick} viewBox="0 0 512 512">
